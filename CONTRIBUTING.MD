...
## Issues
Report a bug by [opening a new issue](https://github.com/malcommac/sentry-cocoa-sdk-xcframeworks/issues). Include steps to reproduce the error (and if possible sample code is always appreciated).
